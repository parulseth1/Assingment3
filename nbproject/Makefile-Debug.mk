...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/assingment3: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/assingment3 ${OBJECTFILES} ${LDLIBSOPTIONS} -lX11 -lXft -lfontconfig -lpthread
...
${OBJECTDIR}/Partition.o: Partition.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Partition.o Partition.cpp
